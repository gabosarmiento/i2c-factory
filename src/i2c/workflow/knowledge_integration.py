...
# Import embedder
from i2c.agents.modification_team.context_utils import _embedding_model as embed_model
...
def enhance_modification_workflow_with_knowledge(
    ...
    from i2c.agents.knowledge.knowledge_manager import EnhancedLanceDb
