# tests/test_direct_modification_via_manager_agno.py
"""
...
def test_direct_modification_team():
    ...
    print("[DEBUG] Clearing session state knowledge cache")
...
""")
        ...
        # Test with minimal session state
        ...
        session_state = {
            ...
            "test_mode": True
            # "knowledge_cache": {},  # Force fresh cache
            # "force_fresh_knowledge": True  # Flag to bypass cache
        }
...
def test_orchestration_vs_direct():
    ...
    # Clear any cached responses before testing
    print("[DEBUG] Clearing session state knowledge cache")
